...
(function(process) {
  !function(a) {
    ...
    !function(c) {
      ...
      var v = new Date(-5e13 - 1),
          O = !(v.toISOString && "0385-07-25T07:06:39.999Z" == v.toISOString() && d(63)(function() {
      ...
      var b = a(52),
          c = {};
      c[a(58)("toStringTag")] = "z", a(49).FW && "z" != b(c) && a(54)(Object.prototype, "toString", function() {
      ...
      }), b.prototype = g, g.constructor = b, f(54)(a.g, i, b));
    }, function(i, j, b) {
      function c(a) {
      ...
      }), f.constructor = b, b.prototype = f, d(54)(c.g, "RegExp", b)), "g" != /./g.flags && c.setDesc(f, "flags", {
        configurable: !0,
        get: d(68)(/^.*\/(\w*)$/, "$1")
      })), d(73)(b);
    }, function(D, C, c) {
 ...
 while (!((d = c[b.i++]) in b.o));
      ...
      d.exports = function(d) {
        return c[d] || (c[d] = b.Symbol && b.Symbol[d] || a(53).safe("Symbol." + d));
      };
    }, function(c, e, a) {
      var b = a(49),
          d = a(56);
      ...
      f.exports = function(j, u, t, l, n) {
        ...
        return b(52).set(f, j), s[j] = f, d(d.G + d.W + d.F * (f != p), s), e(f), e(c.core[j]), n || t.setIter(f, j, l), f;
      };
    }, function(r, u, c) {
      function j(a, b) {
