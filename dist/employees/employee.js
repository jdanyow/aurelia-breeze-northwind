System.register(['../entity-view-model', 'aurelia-dependency-injection', './employee-service'], function (_export) {
  'use strict';

  var EntityViewModel, inject, EmployeeService, missingPhoto, Employee;
  ...
  return {
    ...
    execute: function () {
      ...
      Employee = (function (_EntityViewModel) {
        ...
        Employee = inject(EmployeeService)(Employee) || Employee;
        return Employee;
      })(EntityViewModel);
...
//# sourceMappingURL=data:application/json;base64,